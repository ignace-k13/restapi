...
public class PersonController {
    ...
    @PostMapping("/login")
    public ResponseEntity<? extends Object> findPersonByMailAndPwd(@RequestBody Login login) {
    ...
    private boolean checkApiKey(MultiValueMap<String, String> headers, Person p) {
        boolean ok = false;
